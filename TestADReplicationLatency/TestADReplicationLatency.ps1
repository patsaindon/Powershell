...
#
# -----> !!! DISCLAIMER/REMARKS !!! <------
# * The script is freeware, you are free to distribute it, but always refer to this website (https://jorgequestforknowledge.wordpress.com/) as the location where you got it 
...
Write-Host "                                              *                                                     *" -ForeGroundColor Yellow
Write-Host "                                              *   --> Test AD Replication Latency/Convergence <--   *" -ForeGroundColor Yellow
Write-Host "                                              *                                                     *" -ForeGroundColor Yellow
Write-Host "                                              *******************************************************" -ForeGroundColor Yellow
...
$TableOfDSServersB | Sort-Object Time | FT -AutoSize | Out-File $filename 
