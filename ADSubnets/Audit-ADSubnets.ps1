...
Send-MailMessage -To $emailTo -From $emailFrom -Subject $subject -Attachments $attachment1,$attachment2,$attachment3  -SmtpServer $smtpServer

Remove-Item C:\Scripts\ADSubnets\ADSubnets-Export.csv
Remove-Item C:\Scripts\ADSubnets\ADSubnets-Overlaps.csv
Remove-Item C:\Scripts\ADSubnets\ADSubnets-Superscopes.csv
